...
helps['spring component logs'] = """
    type: command
    short-summary: (Enterprise Tier Only) Show logs for managed components. Logs will be streams when setting '-f/--follow'. For now, only supports subcomponents of (a) Application Configuration Service (b) Spring Cloud Gateway
    examples:
